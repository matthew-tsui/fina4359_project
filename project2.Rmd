...
for (i in 1:5){
  ...
  stargazer(single_bin, type='text', summary=FALSE, title=paste('Bitcoin Weekly Momentum by Groups - bin',i))
}
```
...
for (i in 1:5){
  ...
  stargazer(single_bin, type='text', summary=FALSE, title=paste('Bitcoin Twitter by Groups - bin',i))
}
```
