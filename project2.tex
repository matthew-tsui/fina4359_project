...
\NormalTok{df_tweets[, tweet}\OperatorTok{:}\ErrorTok{=}\KeywordTok{ifelse}\NormalTok{(avg}\OperatorTok{!=}\DecValTok{0}\NormalTok{,cum}\OperatorTok{-}\NormalTok{avg, }\DecValTok{0}\NormalTok{), by=}\KeywordTok{list}\NormalTok{(Date)]}
\KeywordTok{setDT}\NormalTok{(df_tweets)}
